...
fed by an out-of-domain mega-river (Bangkok, Jakarta)~\cite{ref_trinh}, and the
pluvial solver is
...
\bibitem{ref_adb} Asian Development Bank, ``Southeast Asia and the economics of global
climate stabilization,'' 2022.
\bibitem{ref_lenderink} D. P. Lenderink \emph{et al.}, ``Scaling of extreme rainfall
with temperature,'' 2017.
\bibitem{ref_chaussard} D. Chaussard, F. Amelung, H. Abidin, and S.-H. Hong,
...
model for all climates,'' 2024.
\bibitem{ref_hofste} H. Hofste \emph{et al.}, ``Aqueduct Floods methodology,'' World
Resources Institute Tech. Note, 2019.
...
13--29, 2011.
\bibitem{ref_topo} B. Schwanghart and D. Scherler, ``TopoToolbox 2,'' \emph{Earth
Surf. Dynam.}, vol. 2, pp. 1--7, 2014.
\bibitem{ref_barnes} R. Barnes, K. L. Callaghan, and A. D. Wickert, ``Computing water
flow through complex landscapes --- Part 2: Fill--Spill--Merge,'' \emph{Earth Surf.
Dynam.}, vol. 8, pp. 431--445, 2020.
...
46, pp. 159--176, 2002.
\bibitem{ref_trinh} N. Trinh \emph{et al.}, ``Flood risk in the Mekong and Chao Phraya
deltas,'' 2017.
\end{thebibliography}
